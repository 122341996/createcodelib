...
public class getsourseforgegit extends Thread {
	...
	public getsourseforgegit() {

	}

	public getsourseforgegit(int startnum, int endnum, String url, int n,
			String libpath) {
	...
	public void getsfcode(String starturl, String libpath, int threadnum)
		...
		System.err.println("run sf git!!!!!");
		getsourseforgegit gpn = new getsourseforgegit(0, 1, starturl, 0,
				libpath);
		...
		if (threadnum > 1) {
			...
			for (int i = 0; i < (threadnum - 1); i++) {
				getsourseforgegit gpn2 = new getsourseforgegit(i * num + 1,
						(i + 1) * num + 1, starturl, i, libpath);
				gpn2.start();
			}
			getsourseforgegit gpn3 = new getsourseforgegit((threadnum - 1)
					* num, gpn.num, starturl, threadnum - 1, libpath);
			gpn3.start();
		} else {
			getsourseforgegit gpn2 = new getsourseforgegit(1, gpn.num,
					starturl, 0, libpath);
			gpn2.start();
		}
