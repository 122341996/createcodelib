...
public class getsourseforgesvn extends Thread {
	...
	public getsourseforgesvn() {

	}

	public getsourseforgesvn(int startnum, int endnum, String url, int n,
			String libpath) {
	...
	public void getsfcode(String starturl, String libpath, int threadnum)
		...
		System.err.println("run sf svn!!!!!");

		getsourseforgesvn gpn = new getsourseforgesvn(0, 1, starturl, 0,
				libpath);
		...
		if (threadnum > 1) {
			...
			for (int i = 0; i < (threadnum - 1); i++) {
				getsourseforgesvn gpn2 = new getsourseforgesvn(i * num + 1,
						(i + 1) * num + 1, starturl, i, libpath);
				gpn2.start();
			}
			getsourseforgesvn gpn3 = new getsourseforgesvn((threadnum - 1)
					* num, gpn.num, starturl, threadnum - 1, libpath);
			gpn3.start();
		} else {
			getsourseforgesvn gpn2 = new getsourseforgesvn(1, gpn.num,
					starturl, 0, libpath);
			gpn2.start();
		}
